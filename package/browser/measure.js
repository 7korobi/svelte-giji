...
export function KeypadSize({ style }) {
...
export function ViewOffset({ style }) {
  if (!__BROWSER__) return;
...
export function ViewSize({ style }) {
  if (!__BROWSER__) return;
...
export function SafeOffset({ style }) {
  if (!__BROWSER__) return;
...
export function SafeSize({ style }) {
  if (!__BROWSER__) return;
...
export function ZoomOffset({ style }) {
  if (!__BROWSER__) return;
...
export function ZoomSize({ style }) {
  if (!__BROWSER__) return;
