...
export declare const Options: {
    ...
    reduce: <EMIT>(ids: ("entrust" | "select-role" | "random-target" | "seq-event" | "show-id" | "undead-talk" | "aiming-talk")[], emit: (o: EMIT) => void) => import("../../map-reduce/fast-sort").SortCmd<Option & EMIT>;
