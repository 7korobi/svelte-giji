...
import type { BOOK_STORY_IDX, BOOK_STORY_ID, BOOK_EVENT_IDX, BOOK_EVENT_ID, BookEvent, BookStory, BookPotof, BOOK_POTOF_ID, CHR_SET_IDX, Face } from '../map-reduce';
...
export declare type BOOK_MESSAGE_ID = `${string}-${BOOK_STORY_IDX}-${BOOK_EVENT_IDX}-${BOOK_PHASE_IDX}-${number}` | `${string}-${BOOK_STORY_IDX}-${BOOK_EVENT_IDX}-mS-cast` | `${string}-${BOOK_STORY_IDX}-top-mS-title` | `${string}-${BOOK_STORY_IDX}-top-mS-welcome` | `${string}-${BOOK_STORY_IDX}-top-mS-vrule`;
...
export declare const Phases: {
    ...
    del: (ids: ("AIM" | "DEL" | "mS" | "mA" | "aS" | "aA" | "cI" | "iI" | "II" | "SS" | "SA" | "VS" | "VA" | "TS" | "TA" | "GS" | "GA" | "PS" | "PA" | "WS" | "WA" | "XS" | "XA" | "BS" | "BA")[]) => void;
    find: (id: "AIM" | "DEL" | "mS" | "mA" | "aS" | "aA" | "cI" | "iI" | "II" | "SS" | "SA" | "VS" | "VA" | "TS" | "TA" | "GS" | "GA" | "PS" | "PA" | "WS" | "WA" | "XS" | "XA" | "BS" | "BA") => BookPhase;
    reduce: <EMIT>(ids: ("AIM" | "DEL" | "mS" | "mA" | "aS" | "aA" | "cI" | "iI" | "II" | "SS" | "SA" | "VS" | "VA" | "TS" | "TA" | "GS" | "GA" | "PS" | "PA" | "WS" | "WA" | "XS" | "XA" | "BS" | "BA")[], emit: (o: EMIT) => void) => import("../../map-reduce/fast-sort").SortCmd<BookPhase & EMIT>;
    filter: <A extends any[]>(validator: (o: BookPhase, ...args: A) => boolean, key?: string) => (...filter_args: A) => {
        reduce: <EMIT>(ids: ("AIM" | "DEL" | "mS" | "mA" | "aS" | "aA" | "cI" | "iI" | "II" | "SS" | "SA" | "VS" | "VA" | "TS" | "TA" | "GS" | "GA" | "PS" | "PA" | "WS" | "WA" | "XS" | "XA" | "BS" | "BA")[], emit: (o: EMIT) => void) => import("../../map-reduce/fast-sort").SortCmd<BookPhase & EMIT>;
        filter: any;
        sort: () => void;
        data: {
