...
export declare const messages: {
    $match: (ids: import("./map-reduce").BOOK_MESSAGE_ID[]) => {
        _id: {
    ...
    live: ($match: any, set: ($set: BookMessage) => Promise<import("mongodb").ModifyResult<BookMessage>>, del: (ids: import("./map-reduce").BOOK_MESSAGE_ID[]) => Promise<import("mongodb").DeleteResult>) => import("mongodb").ChangeStream<BookMessage>;
