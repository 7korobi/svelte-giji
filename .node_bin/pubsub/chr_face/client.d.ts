...
export declare const message_for_face_mestype_by_face: {
  name?: string;
  qid: (ids: string[]) => string;
  format: () => {
    list: MessageForFaceMestype[];
...
export declare const message_for_face_sow_auth_by_face: {
  name?: string;
  qid: (ids: string[]) => string;
  format: () => {
    list: MessageForFaceSowAuth[];
...
export declare const potof_for_face_by_face: {
  name?: string;
  qid: (ids: string[]) => string;
  format: () => {
    list: PotofForFace[];
...
export declare const potof_for_face_role_by_face: {
  name?: string;
  qid: (ids: string[]) => string;
  format: () => {
    list: PotofForFaceRole[];
...
export declare const potof_for_face_live_by_face: {
  name?: string;
  qid: (ids: string[]) => string;
  format: () => {
    list: PotofForFaceLive[];
