...
export declare const CSIDS: readonly [
  'ririnra',
  'ririnra_c01',
  'ririnra_c05',
  'ririnra_c08',
...
export declare const ChrSets: {
  ...
  reduce: <EMIT>(
    ...
    emit: (o: EMIT) => void
  ) => import('svelte-map-reduce-store/fast-sort').SortCmd<ChrSet & EMIT>;
  filter: <A extends any[]>(
    ...
    subscribe: (
      ...
      invalidate?: (value?: { list: ChrSet[]; by_label: ARY<ARY<ChrSet>> }) => void
...
export declare const ChrNpcs: {
  ...
  reduce: <EMIT>(
    ...
    emit: (o: EMIT) => void
  ) => import('svelte-map-reduce-store/fast-sort').SortCmd<ChrNpc & EMIT>;
  filter: <A extends any[]>(
...
export declare const ChrJobs: {
  ...
  reduce: <EMIT>(
    ...
    emit: (o: EMIT) => void
  ) => import('svelte-map-reduce-store/fast-sort').SortCmd<ChrJob & EMIT>;
  filter: <A extends any[]>(
    ...
    subscribe: (
      ...
      invalidate?: (value?: { list: ChrJob[]; face: DIC<ChrJob[]> }) => void
    ) => import('svelte/store').Unsubscriber;
    validator: (o: ChrJob, ...args: A) => boolean;
  };
  sort: () => void;
