...
export declare const BOOK_FOLDER_IDX: readonly [
  'TEST',
  'LOBBY',
  'OFFPARTY',
  'WOLF',
...
export declare const Folders: {
  ...
  reduce: <EMIT>(
    ...
    emit: (o: EMIT) => void
  ) => import('svelte-map-reduce-store/fast-sort').SortCmd<BookFolder & EMIT>;
  filter: <A extends any[]>(
    ...
    subscribe: (
      ...
      invalidate?: (value?: { list: BookFolder[]; sameSites: Set<string> }) => void
