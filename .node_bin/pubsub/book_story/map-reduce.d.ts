...
import type { BOOK_FOLDER_IDX, SAYCNT, VOTETYPE, GAME, BookFolder, BookEvent, SayLimit, ROLE_ID, MobRole, MOB_ID, Mark, Game, RoleTable, OPTION_ID, Option, MARK_ID, Role, TRAP_ID, SAY_LIMIT_ID, GAME_ID } from '../map-reduce';
export declare type BookStory = {
    _id: BOOK_STORY_ID;
    vid: BOOK_STORY_IDX;
