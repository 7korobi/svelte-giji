  ...
  return function multiPropertySorter(sortBy, sortByArr, depth, order, comparer, a, b) {
    ...
    if (typeof sortBy === 'string') {
      ...
      return multiPropertySorter(
        ...
        objectSorterConfig.comparer || defaultComparer2,
        a,
        b
      );
    }
...
var chr_face_default = [
  ...
  },
  {
    ...
    name: '\u30D9\u30C3\u30AD\u30FC',
    comment:
      '2011/12/06 \u3048\u30FC\u25CB\u25CB\u304C\u8A31\u3055\u308C\u308B\u306E\u306F\u5C0F\u5B66\u751F\u307E\u3067\u3060\u3088\u306D\u30FC\u266A',
    order: 900.145,
    tag_ids: ['giji', 'G_n_h']
  },
  {
  ...
  },
  {
    ...
    name: '\u30AE\u30ED\u30C1\u30F3',
    comment:
      '\u5F31\u3044\u9EBB\u75FA\u6BD2\u304C\u3042\u308B\u304C\u3001\u8C5A\u8089\u306E\u3088\u3046\u306A\u98DF\u611F\u306E\u8338\u3002\u6D1E\u7A9F\u306E\u5929\u4E95\u306A\u3069\u306B\u5B50\u5B9F\u4F53\u3092\u5F62\u6210\u3057\u3001\u5185\u90E8\u306B\u304B\u3064\u3066\u306E\u72A0\u7272\u8005\u304B\u3089\u53CE\u96C6\u3057\u305F\u722A\u7259\u3092\u53CE\u7D0D\u3057\u3066\u3044\u308B\u3002\u8D85\u97F3\u6CE2\u3092\u767A\u3059\u308B\u6027\u8CEA\u304C\u3042\u308A\u3001\u8868\u9762\u306E\u67D4\u6BDB\u3067\u53CD\u97FF\u5B9A\u4F4D\u3092\u884C\u3046\u3068\u3055\u308C\u308B\u3002',
    order: 60024,
    tag_ids: ['fable']
  },
  {
  ...
  },
  {
    ...
    name: '\u30DE\u30C8\u30EA\u30AF\u30B9',
    comment:
      '\u5F3E\u5E55\u7CFB\u30B7\u30E5\u30FC\u30C6\u30A3\u30F3\u30B0\u30B2\u30FC\u30E0\u306E\u81EA\u6A5F\u3092\u3084\u308B\u30B9\u30DD\u30FC\u30C4\u304C\u3001\u660E\u5F8C\u65E5\u306E\u3069\u3053\u304B\u3067\u6D41\u884C\u3057\u3066\u3044\u308B\u3068\u9762\u767D\u3044\u306A\u3002',
    order: 80045,
    tag_ids: ['stratos']
  }
];
...
var 漢字 = numTable(
  ...
  '\u4E07 \u5104 \u5146 \u4EAC \u5793 \u{25771} \u7A63 \u6E9D \u6F97 \u6B63 \u8F09 \u6975 \u6052\u6CB3\u6C99 \u963F\u50E7\u7947 \u90A3\u7531\u4ED6 \u4E0D\u53EF\u601D\u8B70 \u7121\u91CF\u5927\u6570'
);
var 大字 = numTable(
  {
    unit: ['\u6253 \u5BFE \u756A \u8DB3 \u53CC \u5272', [12, 2, 2, 2, 2, 0.1]]
  ...
  '\u842C \u5104 \u5146 \u4EAC \u5793 \u{25771} \u7A63 \u6E9D \u6F97 \u6B63 \u8F09 \u6975 \u6052\u6CB3\u6C99 \u963F\u50E7\u7947 \u90A3\u7531\u4ED6 \u4E0D\u53EF\u601D\u8B70 \u7121\u91CF\u5927\u6570'
);
var よみ = numTable(
  {
    stringify(byScale, _byBig, str, tail) {
...
function numTable(option, itemStr, scaleStr, bigStr) {
  ...
  function calc(num, scaleAt, appendix, isTail = scaleAt === 0) {
    ...
    const toStringed = toString(
      ...
      mBig,
      `${itemStr2}${scaleStr2}`,
      isTail ? `${bigStr2}${appendix}` : `${bigStr2}`
    );
    if (VERBOSE) console.log({ scaleAt, idx: [scaleIdx, bigIdx], str: [itemStr2, scaleStr2, bigStr2] });
...
var [semiVoiceTable, semiVoiceSrc, semiVoiceTgt] = table(
  '\u306F\u3072\u3075\u3078\u307B\u30CF\u30D2\u30D5\u30D8\u30DB',
  '\u3071\u3074\u3077\u307A\u307D\u30D1\u30D4\u30D7\u30DA\u30DD'
);
var semiVoiceDic = replaceChrFactory(semiVoiceTable, semiVoiceSrc, `[\\u309a]`);
var [fullVoiceTable, fullVoiceSrc, fullVoiceTgt] = table(
...
var [bbbTable, bbbSrc, bbbTgt] = table(
...
var [frakturTable, frakturSrc, frakturTgt] = table(
  'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz',
  '\u{1D504}\u{1D505}\u212D\u{1D507}\u{1D508}\u{1D509}\u{1D50A}\u210C\u2111\u{1D50D}\u{1D50E}\u{1D50F}\u{1D510}\u{1D511}\u{1D512}\u{1D513}\u{1D514}\u211C\u{1D516}\u{1D517}\u{1D518}\u{1D519}\u{1D51A}\u{1D51B}\u{1D51C}\u2128\u{1D51E}\u{1D51F}\u{1D520}\u{1D521}\u{1D522}\u{1D523}\u{1D524}\u{1D525}\u{1D526}\u{1D527}\u{1D528}\u{1D529}\u{1D52A}\u{1D52B}\u{1D52C}\u{1D52D}\u{1D52E}\u{1D52F}\u{1D530}\u{1D531}\u{1D532}\u{1D533}\u{1D534}\u{1D535}\u{1D536}\u{1D537}'
);
var [regionTable, regionSrc, regionTgt] = table(
...
var [circleBlackTable, circleBlackSrc, circleBlackTgt] = table(
...
var [circledTable, circledSrc, circledTgt] = table(
...
var [squareTable, squareSrc, squareTgt] = table(
...
var [squaredTable, squaredSrc, squaredTgt] = table(
...
var chr_job3 = [
  ...
  },
  {
    ...
    job: '\u73CA\u745A\u5BAE\u9023\u90A6',
    comment:
      '\u7531\u6765\uFF1A\u6D77\u5E95\u90FD\u5E02\u3001\u51B7\u6CC9\u5C71\u9F8D\u5BAE\u5BFA\u3001\u516B\u5C3E\u6BD4\u4E18\u5C3C\u4F1D\u8AAC'
  },
  {
    face_id: 't76',
    job: 'R\u56E3',
    comment:
      '\u306A\u3093\u3060\u304B\u3093\u3060\u3068\u805E\u304B\u308C\u305F\u3089\u3001\u7B54\u3048\u3066\u3042\u3052\u308B\u4EBA\u9054'
  },
  {
    face_id: 't77',
    job: '\u4FFA\u306B\u6C17\u304C\u3042\u308B',
    comment:
      '\u3044\u3084\u3001\u4FFA\u3060\u3088\u3002\u3044\u3084\u3044\u3084\u3001\u4FFA\u3060\u3063\u3066\u3002\u3044\u3084\u301C\u3001\u4FFA\u3060\u308D\u3046\uFF1F'
  },
  {
    face_id: 't78',
    job: '\u8AF8\u845B\u516B\u5366\u6751',
  ...
  },
  {
    ...
    job: '\u767D\u83CA\u4F1A',
    comment:
      '\u7531\u6765\uFF1A\u767D\u83CA\u907A\u65CF\u4F1A\u3002\u7BE4\u5FD7\u732E\u4F53\u7D44\u7E54\u306E\u767D\u83CA\u4F1A\u3067\u3082\u307E\u3042\u3002\u3088\u3057\u3002'
  },
  {
    face_id: 't86',
    job: '\u4EBA\u5DE5\u77E5\u80FD\u7814',
    comment:
      '\u7531\u6765\uFF1A\u4EBA\u5DE5\u77E5\u80FD\u7814\u7A76\u6240\uFF08MIT, \u3064\u304F\u3070\u5927\u5B66, \u30C9\u30EF\u30F3\u30B4\u306A\u3069\uFF09'
  },
  {
    face_id: 't87',
    job: 'CC',
  ...
  },
  {
    ...
    job: '\u7DBF\u6D25\u898B\u6559\u4F1A',
    comment:
      '\u6D77\u795E\uFF08\u308F\u305F\u3064\u307F\uFF09\u304C\u300C\u5927\u304D\u306A\u5B97\u6559\u300D\u306B\u6539\u5B97\u3057\u305F\u611F\u3058\u3067\u3002\u5927\u516B\u6D32\u56FD\u3067\u3082\u5929\u7167\u72FC\u306E\u5B50\u3089\u304C\u4ECF\u9053\u306B\u5E30\u4F9D\u3057\u305F\u3063\u3066\u3044\u3046\u3057\u3002'
  },
  {
    face_id: 't93',
    job: 'Holy Arkham!',
    comment:
      'M\u5927\u65E5\u672C\u6821\u3067\u306F\u3001\uFF13\u5E74\u6642\u306B\u30DE\u30B5\u30C1\u30E5\u30FC\u30BB\u30C3\u30C4\u5DDE\u306B\u3042\u308B\u672C\u6821\u306B\u7559\u5B66\u3059\u308B\u5236\u5EA6\u304C\u3042\u308A\u3001\u5F7C\u7B49\u306F\u5C06\u6765\u306E\u30D6\u30ED\u30FC\u30C9\u30A6\u30A7\u30A4\u3092\u5922\u898B\u308B\u306E\u3060\u3002'
  },
  {
    face_id: 't94',
    job: 'Holy Arkham!',
  ...
  },
  {
    ...
    job: '\u8B77\u56FD\u8056\u7363',
    comment:
      '\u304B\u3064\u3066\u30B4\u30B8\u30E9\u3068\u6226\u3063\u305F\u8B77\u56FD\u4E09\u8056\u7363\u3001\u5A46\u7F85\u8B77\u543D\u3001\u6700\u73E0\u7F85\u3001\u9B4F\u6012\u7F85\u306B\u3042\u3084\u304B\u3063\u3066\u3002\u5A46\u7F85\u9640\u9B4F\u5C71\u795E\u306F\u4E09\u8056\u7363\u307B\u3069\u5F37\u529B\u3067\u306F\u306A\u3044\u6C17\u6301\u3061\u3067\u3002'
  },
  {
    face_id: 't97',
    job: '\u9640\u7F85\u5C3C',
...
var chr_job5 = [
  ...
  },
  {
    ...
    job: '\u7DB2\u9271\u5EA7',
    comment:
      '\u30A6\u30A7\u30D6\u3068\u9271\u5E8A\u3092\u6DF7\u305C\u305F\u9020\u8A9E\u3002\u30C1\u30A7\u30A4\u30F3\u30E1\u30A4\u30EB\u4F5C\u308B\u306E\u5F97\u610F\u306A\u30C9\u30EF\u30FC\u30D5\u3066\u304D\u306A'
  },
  {
    face_id: 'f34',
    job: '\u6D6E\u7A74\u6CAB\u5A9B',
    comment:
      '\u6D2A\u6C34\u578B\u5144\u59B9\u59CB\u7956\u795E\u8A71\u3068\u571F\u8718\u86DB\uFF08\u671D\u5EF7\u306B\u5F93\u308F\u306A\u3044\u6C11\uFF09\u304B\u3089'
  },
  {
    face_id: 'f35',
    job: '\u8CEA\u8349\u5EA7',
...
var cs = {
  ririnra: cs_ririnra_default,
  wa: cs_wa_default,
  time: cs_time_default,
  sf: cs_sf_default,
  fable: cs_fable_default,
  mad: cs_mad_default,
  ger: cs_ger_default,
  changed: cs_changed_default,
  animal: cs_animal_default,
  school: cs_school_default,
  all: cs_all_default
};
var CHR_SET_IDS = ['ririnra', 'wa', 'time', 'sf', 'fable', 'mad', 'ger', 'changed', 'animal', 'school', 'all'];
...
var T_h_w = {
  label: '\u306F\u301C\u3092',
  long:
    '\u300C\u5E30\u9084\u8005\u8B70\u4E8B\u300D\u306E\u540D\u524D\u304C \u306F\u3001\u307E\u3001\u3084\u3001\u3089\u3001\u308F \u884C\u306E\u30AD\u30E3\u30E9\u30AF\u30BF\u30FC\u540D\u7C3F',
  head: '\u5E30\u9084\u8005\u8B70\u4E8B',
  tag_id: 'travel',
  chr_set_id: 'time',
  face_sort: ['face.q.head', 'asc'],
...
var incite = {
  ...
  pass: '\u2015\u2015\u2015',
  change:
    '\u305F\u3060\u3061\u306B\u767A\u8A00\u6B8B\u91CF\u3092\u56DE\u5FA9\u3055\u305B\u305F\u3044\u76F8\u624B\u3092\u9078\u629E\u3057\u3066\u304F\u3060\u3055\u3044\u3002',
  help:
    '\u8A71\u306E\u7D9A\u304D\u3092\u4FC3\u3057\u3001\u3082\u3046\u5C11\u3057\u3060\u3051\u767A\u8A00\u3057\u3066\u3082\u3089\u3046\u4F59\u529B\u3092\u4E0E\u3048\u308B\u3053\u3068\u304C\u3067\u304D\u307E\u3059\u3002'
};
var guru = {
  at: 'progress',
  for: 'live',
...
var entrust = {
  ...
  pass: '\uFF08\u6295\u7968\u3059\u308B\uFF09',
  change:
    '\u51E6\u5211\u3092\u68C4\u6A29\u3057\u3001\u4E00\u7968\u3092\u59D4\u306D\u308B\u76F8\u624B\u3092\u9078\u629E\u3057\u3066\u304F\u3060\u3055\u3044\u3002',
  help:
    '\u6295\u7968\u306F\u68C4\u6A29\u3057\u3001\u4ED6\u4EBA\u306E\u6295\u7968\u3068\u540C\u3058\u3068\u3059\u308B\u3053\u3068\u304C\u3067\u304D\u307E\u3059\u3002'
};
var jammer = {
  for: 'live',
  at: 'progress',
...
var grave = {
  help:
    '\u547D\u3092\u843D\u3068\u3059\u3068\u3001\u80FD\u529B\u3092\u767A\u63EE\u3059\u308B\u3053\u3068\u304C\u3067\u304D\u307E\u3059\u3002'
};
var armor = {
  help:
    '\u72FC\u306E\u8972\u6483\u3084\u8CDE\u91D1\u7A3C\u306E\u624B\u306B\u3088\u308A\u6BBA\u3055\u308C\u308B\u3053\u3068\u306F\u3042\u308A\u307E\u305B\u3093\u3002'
};
var medium = {
  help:
...
var lost = {
  ...
  able_ids: [],
  help:
    '\u3042\u306A\u305F\u306F\u8D08\u308A\u7269\u3092<A href="http://dais.kokage.cc/guide/?(Gift)GIFTID_LOST" TARGET="_blank">\u55AA\u5931</A>\u3057\u307E\u3057\u305F\u3002 \u3082\u3046\u4E8C\u5EA6\u3068\u624B\u306B\u3059\u308B\u3053\u3068\u306F\u306A\u3044\u3067\u3057\u3087\u3046\u3002\u3082\u3057\u307E\u305F\u3042\u306A\u305F\u306E\u624B\u306B\u8D08\u308A\u7269\u304C\u6E21\u3063\u3066\u3082\u3001\u6D88\u3048\u53BB\u3063\u3066\u3057\u307E\u3044\u307E\u3059\u3002\u305D\u3057\u3066\u3001\u3042\u306A\u305F\u304C\u305D\u308C\u306B\u6C17\u4ED8\u304F\u3053\u3068\u306F\u306A\u3044\u3067\u3057\u3087\u3046\u3002'
};
var shield = {
  label: '\u5149\u306E\u8F2A',
  win: null,
  ...
  help:
    '\u3042\u306A\u305F\u3092<A href="http://dais.kokage.cc/guide/?(Gift)GIFTID_SHIELD" TARGET="_blank">\u5149\u306E\u8F2A</A>\u304C\u53D6\u308A\u5DFB\u304D\u307E\u3059\u3002 \u3042\u306A\u305F\u306F\u3082\u3057\u6628\u591C\u3001\u8972\u6483\u3055\u308C\u3066\u3044\u305F\u3068\u3057\u3066\u3082\u5B88\u3089\u308C\u307E\u3057\u305F\u3002 \u5149\u306E\u8F2A\u306F\u3072\u3068\u308A\u3092\u4E00\u5EA6\u3057\u304B\u5B88\u308A\u307E\u305B\u3093\u3002'
};
var glass = {
  label: '\u9B54\u93E1',
  win: null,
  ...
  help:
    '\u3042\u306A\u305F\u3092<A href="http://dais.kokage.cc/guide/?(Gift)GIFTID_GLASS" TARGET="_blank">\u9B54\u93E1</A>\u304C\u7167\u3089\u3057\u307E\u3059\u3002 \u3042\u306A\u305F\u306F\u3001\u9B54\u93E1\u3092\u6E21\u3059\u76F8\u624B\u3092\u5360\u3044\u307E\u3059\u3002 \u9B54\u93E1\u306F\u3072\u3068\u308A\u3092\u4E00\u5EA6\u3057\u304B\u7167\u3089\u3057\u307E\u305B\u3093\u3002'
};
var ogre = {
  label: '\u60AA\u9B3C',
  win: 'WOLF',
  ...
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Gift)GIFTID_OGRE" TARGET="_blank">\u60AA\u9B3C</A>\u3067\u3059\u3002 \u8868\u5411\u304D\u306F\u4ED6\u306E\u5F79\u76EE\u3092\u5E2F\u3073\u3066\u3044\u307E\u3059\u304C\u3001\u3042\u306A\u305F\u306F\u4EBA\u3092\u8972\u3046\u60AA\u3044\u9B3C\u306A\u306E\u3067\u3059\u3002'
};
var fairy = {
  label: '\u5996\u7CBE\u306E\u5B50',
  win: 'PIXI',
  ...
  able_ids: ['pixi'],
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Gift)GIFTID_FAIRY" TARGET="_blank">\u5996\u7CBE\u304B\u3089\u751F\u307E\u308C\u305F\u5B50</A>\u3067\u3059\u3002 \u8868\u5411\u304D\u306F\u4ED6\u306E\u5F79\u76EE\u3092\u5E2F\u3073\u3066\u3044\u307E\u3059\u304C\u3001\u3042\u306A\u305F\u306F\u4EBA\u306A\u3089\u306C\u5B58\u5728\u306A\u306E\u3067\u3059\u3002 \u5360\u3044\u5E2B\u3001\u970A\u80FD\u8005\u306B\u3069\u3046\u5224\u5225\u3055\u308C\u308B\u304B\u306F\u3001\u3082\u3068\u3082\u3068\u306E\u5F79\u8077\u306B\u3088\u308A\u307E\u3059\u3002'
};
var fink = {
  label: '\u534A\u7AEF\u8005',
  win: 'EVIL',
  ...
  able_ids: ['evil'],
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Gift)GIFTID_FINK" TARGET="_blank">\u534A\u7AEF\u8005</A>\u3067\u3059\u3002 \u8868\u5411\u304D\u306F\u4ED6\u306E\u5F79\u76EE\u3092\u5E2F\u3073\u3066\u3044\u307E\u3059\u304C\u3001\u3042\u306A\u305F\u306F\u4EBA\u3068\u3082\u3064\u304B\u306C\u3001\u4EBA\u72FC\u3068\u3082\u3064\u304B\u306C\u3001\u534A\u7AEF\u306A\u6B63\u4F53\u3092\u96A0\u3057\u3066\u3044\u307E\u3059\u3002'
};
var decide = {
  label: '\u6C7A\u5B9A\u8005',
  win: null,
  ...
  able_ids: ['vote'],
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Gift)GIFTID_DECIDE" TARGET="_blank">\u6C7A\u5B9A\u8005</A>\u3067\u3059\u3002 \u3042\u306A\u305F\u306F\u8FFD\u52A0\u7968\u3092\u6295\u3058\u308B\u6A29\u5229\u3092\u6301\u3061\u3064\u3065\u3051\u307E\u3059\u3002\u884C\u4F7F\u3059\u308B\u3053\u3068\u3067\u3001\u5065\u5728\u3092\u793A\u3059\u3053\u3068\u3082\u3067\u304D\u308B\u3067\u3057\u3087\u3046\u3002'
};
var seeronce = {
  label: '\u5922\u5360\u5E2B',
  win: null,
  ...
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Gift)GIFTID_SEERONCE" TARGET="_blank">\u5922\u5360\u5E2B</A>\u3067\u3059\u3002'
};
var dipsy = {
  label: '\u9154\u6255\u3044',
  win: null,
  ...
  able_ids: [],
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Gift)GIFTID_DIPSY" TARGET="_blank">\u9154\u6255\u3044</A>\u3067\u3059\u3002 \u3042\u306A\u305F\u304C\u4EBA\u5916\u3082\u3057\u304F\u306F\u6751\u4EBA\u306B\u76F8\u5BFE\u3059\u308B\u3082\u306E\u3067\u3042\u308C\u3070\u3001\u81EA\u5206\u306E\u5F79\u5272\u3092\u898B\u5931\u3046\u3053\u3068\u306F\u3042\u308A\u307E\u305B\u3093\u3002 \u307E\u305F\u3001\u5149\u306E\u8F2A\u3084\u9B54\u93E1\u3068\u3044\u3063\u305F\u8D08\u308A\u7269\u3092\u53D7\u3051\u53D6\u3063\u305F\u5834\u5408\u3001\u9154\u3044\u304C\u9192\u3081\u308B\u3053\u3068\u3067\u3057\u3087\u3046\u3002'
};
var lover = {
  label: '\u5F1F\u5B50',
  win: null,
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_LOVER" TARGET="_blank">\u5F1F\u5B50</A>\u3067\u3059\u3002 \u597D\u304D\u306A\u4EBA\u7269\u3092\u5E2B\u5320\u3068\u3057\u3066\u9078\u3073\u3001\u5F1F\u5B50\u5165\u308A\u3057\u307E\u3059\u3002\u6B21\u306E\u671D\u3001\u3042\u306A\u305F\u306F\u982D\u89D2\u3092\u3042\u3089\u308F\u3057\u3001\u7D46\u306E\u5E2B\u5320\u3068\u540C\u3058\u5F79\u8077\u306B\u306A\u3063\u3066\u3044\u307E\u3059\u3002'
};
var robber = {
  label: '\u76D7\u8CCA',
  win: null,
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_ROBBER" TARGET="_blank">\u76D7\u8CCA</A>\u3067\u3059\u3002'
};
...
var juror = {
  ...
  help:
    '\u9032\u884C\u4E2D\u4F1A\u8A71\u306F\u966A\u5BE9\u540C\u58EB\u306E\u307F\u3002\u966A\u5BE9\uFF08\uFF06\u6C7A\u5B9A\u8005\uFF09\u3060\u3051\u304C\u6295\u7968\u3059\u308B\u3002'
};
var gamemaster = {
  label: '\u9ED2\u5E55',
  win: 'MOB',
  group: 'MOB',
  able_ids: ['gm_droop', 'gm_live', 'gm_disable_vote', 'gm_enable_vote', 'VSAY', 'TSAY', 'incite'],
  help:
    '\u9032\u884C\u4E2D\u4F1A\u8A71\u306F\u5730\u4E0A\u3001\u5893\u4E0B\u3001\u4E21\u65B9\u3068\u3002\u5834\u3092\u652F\u914D\u3059\u308B\u7279\u6A29\u3092\u3082\u3064\u3002'
};
...
var turnfairy = {
  ...
  able_ids: [],
  help:
    '<h3><A href="http://dais.kokage.cc/guide/?(Event)EVENTID_TURN_FAIRY" TARGET="_blank">\u5996\u7CBE\u306E\u8F2A</A></h3>\n\u306A\u3093\u3068\u3044\u3046\u3053\u3068\u3060\u308D\u3046\uFF01\u4E00\u4EBA\u304C\u68EE\u306B\u7ACB\u3061\u5165\u308A\u3001\u5996\u7CBE\u306E\u990A\u5B50\u306B\u306A\u3063\u3066\u3057\u307E\u3063\u305F\u3002\u660E\u65E5\u4EE5\u964D\u3082\u3001\u5F7C\u306F\u6751\u4EBA\u3092\u88CF\u5207\u308A\u7D9A\u3051\u308B\u3060\u308D\u3046\u2026\u2026\u3002\n\u6C7A\u5B9A\u8005\u3084\u5149\u306E\u8F2A\u306E\u6301\u3061\u4E3B\u306A\u3089\u3001\u3053\u306E\u3068\u304D\u306B\u305D\u306E\u529B\u3092\u624B\u653E\u3057\u3066\u3057\u307E\u3046\u3002'
};
var eclipse = {
  label: '\u65E5\u8755',
  win: null,
  ...
  able_ids: [],
  help:
    '<h3><A href="http://dais.kokage.cc/guide/?(Event)EVENTID_ECLIPSE" TARGET="_blank">\u65E5\u8755</A></h3>\n\u6697\u3044\u65E5\u8755\u304C\u6751\u4E2D\u3092\u8986\u3044\u3001\u304A\u4E92\u3044\u9854\u3082\u540D\u524D\u3082\u89E3\u3089\u306A\u3044\u3002\u3053\u306E\u95C7\u591C\u306F\u4E38\u4E00\u65E5\u7D9A\u304F\u3060\u308D\u3046\u3002\u4ED6\u4EBA\u306B\u306A\u308A\u3059\u307E\u3057\u3001\u8B70\u8AD6\u3092\u6DF7\u4E71\u3055\u305B\u308B\u3053\u3068\u3082\u3067\u304D\u3066\u3057\u307E\u3046\u304B\u3082\u3057\u308C\u306A\u3044\u3002'
};
var cointoss = {
  label: 'Sir Cointoss',
  win: null,
...
var force = {
  ...
  able_ids: [],
  help:
    '<h3><A href="http://dais.kokage.cc/guide/?(Event)EVENTID_FORCE" TARGET="_blank">\u5F71\u97FF\u529B</A></h3>\n\u4ECA\u65E5\u306E\u6295\u7968\u7BB1\u306F\u7121\u8272\u900F\u660E\u3060\u3002\u3060\u308C\u304B\u304C\u6295\u7968\u3057\u305F\u77AC\u9593\u306B\u305D\u306E\u5185\u5BB9\u306F\u30CF\u30C3\u30AD\u30EA\u3068\u898B\u3048\u308B\u304B\u3089\u3001\u6295\u7968\u3092\u30BB\u30C3\u30C8\u3059\u308B\u3068\u304D\u306F\u6C17\u3092\u4ED8\u3051\u3066\uFF01'
};
var miracle = {
  label: '\u5947\u8DE1',
  win: null,
...
var ghost = {
  ...
  able_ids: [],
  help:
    '<h3><A href="http://dais.kokage.cc/guide/?(Event)EVENTID_GHOST" TARGET="_blank">\u4EA1\u970A</A></h3>\n\u4ECA\u591C\u3001\u4EBA\u72FC\u306B\u6BBA\u3055\u308C\u305F\u4EBA\u306F\u4EBA\u72FC\u306B\u306A\u308B\u3002\u307E\u305F\u3001\u8972\u6483\u3092\u5B9F\u884C\u3057\u305F\u4EBA\u72FC\u306F\u547D\u3092\u843D\u3068\u3057\u3066\u3057\u307E\u3046\u3060\u308D\u3046\u3002\u4EBA\u72FC\u3068\u306A\u3063\u305F\u8005\u306F\u5831\u5FA9\u884C\u52D5\u3092\u884C\u308F\u306A\u3044\u3002\u305F\u3060\u3057\u3001\u547D\u62FE\u3044\u3092\u3057\u305F\u306A\u3089\u3070\u4EBA\u72FC\u306B\u306F\u306A\u3089\u306A\u3044\u3002\n\u4E00\u5339\u72FC\u306F\u4EA1\u970A\u3092\u4F5C\u3089\u306A\u3044\u3002'
};
var escape = {
  label: '\u9003\u4EA1',
  win: null,
...
var seance = {
  ...
  able_ids: [],
  help:
    '<h3><A href="http://dais.kokage.cc/guide/?(Event)EVENTID_SEANSE" TARGET="_blank">\u964D\u970A\u4F1A</A></h3>\n\u3053\u3063\u304F\u308A\u3055\u3093\u3001\u3053\u3063\u304F\u308A\u3055\u3093\u2026\u2026 \u79D8\u5BC6\u306E\u5100\u5F0F\u3067\u3001\u5893\u5834\u306E\u970A\u9B42\u304C\u304B\u3048\u3063\u3066\u304D\u305F\u3002\u4ECA\u65E5\u306B\u9650\u308A\u3001\u751F\u8005\u3082\u59FF\u306E\u898B\u3048\u306C\u6B7B\u8005\u3082\u5C4B\u6839\u3092\u5171\u306B\u3057\u3001\u8B70\u8AD6\u3059\u308B\u3060\u308D\u3046\u3002'
};
...
var tangle2 = {
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_TANGLE" TARGET="_blank">\u6028\u5FF5</A>\u3067\u3059\u3002'
};
var villager = {
  label: '\u6751\u4EBA',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_VILLAGER" TARGET="_blank">\u6751\u4EBA</A>\u3067\u3059\u3002 \u7279\u6B8A\u306A\u80FD\u529B\u306F\u3082\u3063\u3066\u3044\u307E\u305B\u3093\u3002'
};
var stigma2 = {
  label: '\u8056\u75D5\u8005',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_STIGMA" TARGET="_blank">\u8056\u75D5\u8005</A>\u3067\u3059\u3002'
};
var fm2 = {
  label: '\u7D50\u793E\u54E1',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_FM" TARGET="_blank">\u7D50\u793E\u54E1</A>\u3067\u3059\u3002 \u72EC\u81EA\u306E\u4EBA\u8108\u3092\u6301\u3064\u79D8\u5BC6\u7D50\u793E\u306E\u4E00\u54E1\u3067\u3059\u3002'
};
var sympathy = {
  label: '\u5171\u9CF4\u8005',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_SYMPATHY" TARGET="_blank">\u5171\u9CF4\u8005</A>\u3067\u3059\u3002'
};
var seer = {
  label: '\u5360\u3044\u5E2B',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_SEER" TARGET="_blank">\u5360\u3044\u5E2B</A>\u3067\u3059\u3002'
};
var seerwin = {
  label: '\u4FE1\u4EF0\u5360\u5E2B',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_SEERWIN" TARGET="_blank">\u4FE1\u4EF0\u5360\u5E2B</A>\u3067\u3059\u3002'
};
var aura2 = {
  label: '\u6C17\u5360\u5E2B',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_AURA" TARGET="_blank">\u6C17\uFF08\u30AA\u30FC\u30E9\uFF09\u5360\u3044\u5E2B</A>\u3067\u3059\u3002'
};
var oura = {
  label: '\u6C17\u5360\u5E2B',
  win: 'HUMAN',
...
var seerrole = {
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_SEERROLE" TARGET="_blank">\u8CE2\u8005</A>\u3067\u3059\u3002'
};
var guard2 = {
  label: '\u5B88\u8B77\u8005',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_GUARD" TARGET="_blank">\u5B88\u8B77\u8005</A>\u3067\u3059\u3002'
};
var medium2 = {
  label: '\u970A\u80FD\u8005',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_MEDIUM" TARGET="_blank">\u970A\u80FD\u8005</A>\u3067\u3059\u3002'
};
var mediumwin = {
  label: '\u4FE1\u4EF0\u970A\u80FD\u8005',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_MEDIUMWIN" TARGET="_blank">\u4FE1\u4EF0\u970A\u80FD\u8005</A>\u3067\u3059\u3002'
};
var mediumrole = {
  label: '\u5C0E\u5E2B',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_MEDIUMROLE" TARGET="_blank">\u5C0E\u5E2B</A>\u3067\u3059\u3002'
};
var necromancer = {
  label: '\u964D\u970A\u8005',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_NECROMANCER" TARGET="_blank">\u964D\u970A\u8005</A>\u3067\u3059\u3002'
};
var follow = {
  label: '\u8FFD\u5F93\u8005',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_FOLLOW" TARGET="_blank">\u8FFD\u5F93\u8005</A>\u3067\u3059\u3002 \u3060\u308C\u304B\u3092\u4FE1\u3058\u3001\u59D4\u306D\u307E\u3057\u3087\u3046\u3002'
};
var fan = {
  label: '\u717D\u52D5\u8005',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_FAN" TARGET="_blank">\u717D\u52D5\u8005</A>\u3067\u3059\u3002'
};
var hunter = {
  label: '\u8CDE\u91D1\u7A3C',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_HUNTER" TARGET="_blank">\u8CDE\u91D1\u7A3C</A>\u3067\u3059\u3002 \u6BCE\u591C\u3001\u4E00\u4EBA\u3092\u4ED8\u3051\u72D9\u3044\u307E\u3059\u3002'
};
var weredog = {
  label: '\u4EBA\u72AC',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_WEREDOG" TARGET="_blank">\u4EBA\u72AC</A>\u3067\u3059\u3002'
};
var prince = {
  label: '\u738B\u5B50\u69D8',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_PRINCE" TARGET="_blank">\u738B\u5B50\u69D8</A>\u3067\u3059\u3002'
};
var rightwolf = {
  label: '\u72FC\u8840\u65CF',
  win: 'HUMAN',
...
var doctor = {
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_DOCTOR" TARGET="_blank">\u533B\u5E2B</A>\u3067\u3059\u3002'
};
var curse2 = {
  label: '\u546A\u4EBA',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_CURSE" TARGET="_blank">\u546A\u4EBA</A>\u3067\u3059\u3002'
};
var dying = {
  label: '\u9810\u8A00\u8005',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_DYING" TARGET="_blank">\u9810\u8A00\u8005</A>\u3067\u3059\u3002'
};
var invalid = {
  label: '\u75C5\u4EBA',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_INVALID" TARGET="_blank">\u75C5\u4EBA</A>\u3067\u3059\u3002 \u3042\u306A\u305F\u304C\u547D\u3092\u843D\u3068\u3057\u305F\u3068\u304D\u3001\u72AF\u4EBA\u306F\u75C5\u6C17\u306B\u611F\u67D3\u3057\u307E\u3059\u3002'
};
var alchemist = {
  label: '\u932C\u91D1\u8853\u5E2B',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_ALCHEMIST" TARGET="_blank">\u932C\u91D1\u8853\u5E2B</A>\u3067\u3059\u3002 \u3042\u306A\u305F\u306F\u4E00\u5EA6\u3060\u3051\u3001\u85AC\u3092\u98F2\u3080\u3053\u3068\u304C\u51FA\u6765\u307E\u3059\u3002'
};
var witch = {
  label: '\u9B54\u5973',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_WITCH" TARGET="_blank">\u9B54\u5973</A>\u3067\u3059\u3002 \u3042\u306A\u305F\u306F\u4E8C\u65E5\u76EE\u306B\u3001\u6BD2\u85AC\u3068\u8607\u751F\u85AC\u3092\u3072\u3068\u3064\u305A\u3064\u5B8C\u6210\u3055\u305B\u307E\u3059\u3002'
};
var girl = {
  label: '\u5C11\u5973',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_GIRL" TARGET="_blank">\u5C11\u5973</A>\u3067\u3059\u3002'
};
var scapegoat2 = {
  label: '\u751F\u8D04',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_SCAPEGOAT" TARGET="_blank">\u751F\u8D04</A>\u3067\u3059\u3002'
};
var elder = {
  label: '\u9577\u8001',
  win: 'HUMAN',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_ELDER" TARGET="_blank">\u9577\u8001</A>\u3067\u3059\u3002 \u3082\u3057\u3082\u547D\u3092\u843D\u3068\u3057\u305F\u3089\u3001\u3042\u306A\u305F\u306E\u6068\u307F\u306F\u72AF\u4EBA\u3092\u8972\u3044\u307E\u3059\u3002'
};
var jammer2 = {
  label: '\u90AA\u9B54\u4E4B\u6C11',
  win: 'EVIL',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_JAMMER" TARGET="_blank">\u90AA\u9B54\u4E4B\u6C11</A>\u3067\u3059\u3002'
};
var snatch2 = {
  label: '\u5BBF\u501F\u4E4B\u6C11',
  win: 'EVIL',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_SNATCH" TARGET="_blank">\u5BBF\u501F\u4E4B\u6C11</A>\u3067\u3059\u3002'
};
var bat = {
  label: '\u5FF5\u6CE2\u4E4B\u6C11',
  win: 'EVIL',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_BAT" TARGET="_blank">\u5FF5\u6CE2\u4E4B\u6C11</A>\u3067\u3059\u3002'
};
var possess = {
  label: '\u72C2\u4EBA',
  win: 'EVIL',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_POSSESS" TARGET="_blank">\u72C2\u4EBA</A>\u3067\u3059\u3002'
};
var fanatic2 = {
  label: '\u72C2\u4FE1\u8005',
  win: 'EVIL',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_FANATIC" TARGET="_blank">\u72C2\u4FE1\u8005</A>\u3067\u3059\u3002'
};
var muppeting = {
  label: '\u4EBA\u5F62\u4F7F\u3044',
  win: 'EVIL',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_MUPPETER" TARGET="_blank">\u4EBA\u5F62\u4F7F\u3044</A>\u3067\u3059\u3002'
};
var wisper = {
  label: '\u56C1\u304D\u72C2\u4EBA',
  win: 'EVIL',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_WISPER" TARGET="_blank">\u56C1\u304D\u72C2\u4EBA</A>\u3067\u3059\u3002 \u5C11\u4EBA\u6570\u306B\u306A\u308B\u3068\u52DD\u6557\u304C\u78BA\u5B9A\u3059\u308B\u72B6\u6CC1\u3082\u3042\u308A\u307E\u3059\u3001\u3067\u3059\u304C\u3053\u306E\u5834\u5408\u3082\u81EA\u52D5\u3067\u7D42\u4E86\u3059\u308B\u3053\u3068\u306F\u3042\u308A\u307E\u305B\u3093\u3002'
};
var cpossess = {
  label: '\u56C1\u304D\u72C2\u4EBA',
  win: 'EVIL',
...
var semiwolf = {
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_SEMIWOLF" TARGET="_blank">\u534A\u72FC</A>\u3067\u3059\u3002'
};
var oracle = {
  label: '\u9B54\u795E\u5B98',
  win: 'EVIL',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_ORACLE" TARGET="_blank">\u9B54\u795E\u5B98</A>\u3067\u3059\u3002'
};
var sorcerer = {
  label: '\u9B54\u8853\u5E2B',
  win: 'EVIL',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_SORCERER" TARGET="_blank">\u9B54\u8853\u5E2B</A>\u3067\u3059\u3002'
};
var walpurgis = {
  label: '\u9B54\u6CD5\u5C11\u5E74',
  win: 'EVIL',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_WALPURGIS" TARGET="_blank">\u9B54\u6CD5\u5C11\u5E74</A>\u3067\u3059\u3002 \u3084\u304C\u3066\u547D\u3092\u843D\u3068\u3059\u3068\u9B54\u5973\u306B\u306A\u308B\u3068\u5BBF\u547D\u4ED8\u3051\u3089\u308C\u3066\u3044\u307E\u3059\u3002'
};
var headless = {
  label: '\u9996\u7121\u9A0E\u58EB',
  win: 'WOLF',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_HEADLESS" TARGET="_blank">\u9996\u306E\u306A\u3044\u9A0E\u58EB</A>\u3067\u3059\u3002 \u3042\u306A\u305F\u306F\u4EBA\u72FC\u4EF2\u9593\u3092\u65AC\u308A\u6368\u3066\u308B\u3053\u3068\u3082\u53AD\u3044\u307E\u305B\u3093\u3002'
};
var wolf2 = {
  label: '\u4EBA\u72FC',
  win: 'WOLF',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_WOLF" TARGET="_blank">\u4EBA\u72FC</A>\u3067\u3059\u3002'
};
var intwolf = {
  label: '\u667A\u72FC',
  win: 'WOLF',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_INTWOLF" TARGET="_blank">\u667A\u72FC</A>\u3067\u3059\u3002\u7279\u6B8A\u306A\u80FD\u529B\u3092\u6301\u3064\u4EBA\u72FC\u3067\u3059\u3002'
};
var cwolf = {
  label: '\u546A\u72FC',
  win: 'WOLF',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_CURSEWOLF" TARGET="_blank">\u546A\u72FC</A>\u3067\u3059\u3002\u7279\u6B8A\u306A\u80FD\u529B\u3092\u6301\u3064\u4EBA\u72FC\u3067\u3059\u3002'
};
var cursewolf = {
  label: '\u546A\u72FC',
  win: 'WOLF',
...
var whitewolf = {
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_WHITEWOLF" TARGET="_blank">\u767D\u72FC</A>\u3067\u3059\u3002\u7279\u6B8A\u306A\u80FD\u529B\u3092\u6301\u3064\u4EBA\u72FC\u3067\u3059\u3002 \u3042\u306A\u305F\u3092\u5360\u3063\u305F\u5360\u3044\u5E2B\u306F\u3001\u3042\u306A\u305F\u3092\u4EBA\u9593\u3068\u307F\u306A\u3057\u307E\u3059\u3002\u3042\u306A\u305F\u306F\u80FD\u529B\u8005\u7279\u6709\u306E\u30AA\u30FC\u30E9\u3092\u767A\u3057\u307E\u305B\u3093\u3002'
};
var childwolf = {
  label: '\u4ED4\u72FC',
  win: 'WOLF',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_CHILDWOLF" TARGET="_blank">\u4ED4\u72FC</A>\u3067\u3059\u3002\u7279\u6B8A\u306A\u80FD\u529B\u3092\u6301\u3064\u4EBA\u72FC\u3067\u3059\u3002'
};
var dyingwolf = {
  label: '\u8870\u72FC',
  win: 'WOLF',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_DYINGWOLF" TARGET="_blank">\u8870\u72FC</A>\u3067\u3059\u3002\u7279\u6B8A\u306A\u80FD\u529B\u3092\u6301\u3064\u4EBA\u72FC\u3067\u3059\u3002'
};
var silentwolf = {
  label: '\u9ED9\u72FC',
  win: 'WOLF',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_SILENTWOLF" TARGET="_blank">\u9ED9\u72FC</A>\u3067\u3059\u3002 \u4EBA\u72FC\u306E\u8972\u6483\u5BFE\u8C61\u3068\u306A\u308B\u3053\u3068\u306F\u3042\u308A\u307E\u305B\u3093\u304C\u3001\u4EBA\u72FC\uFF08\u3068\u56C1\u304D\u72C2\u4EBA\u3001\u64EC\u72FC\u5996\u7CBE\uFF09\u540C\u58EB\u306B\u3057\u304B\u805E\u3053\u3048\u306A\u3044\u4F1A\u8A71\u306F\u3001\u3042\u306A\u305F\u306B\u306F\u805E\u3053\u3048\u307E\u305B\u3093\u3002'
};
var hamster = {
  label: '\u6817\u9F20\u5996\u7CBE',
  win: 'PIXI',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_PIXI" TARGET="_blank">\u6817\u9F20\u5996\u7CBE</A>\u3067\u3059\u3002'
};
var werebat = {
  label: '\u8759\u8760\u5996\u7CBE',
  win: 'PIXI',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_BAT" TARGET="_blank">\u8759\u8760\u5996\u7CBE</A>\u3067\u3059\u3002 \u3042\u306A\u305F\u306F\u4ED6\u306E\u5996\u7CBE\u304C\u8AB0\u3067\u3042\u308B\u304B\u77E5\u3063\u3066\u3044\u307E\u3059\u3057\u3001\u65B0\u305F\u306B\u751F\u307E\u308C\u305F\u5996\u7CBE\u3092\u77E5\u308B\u3053\u3068\u3082\u3067\u304D\u307E\u3059\u3002\u305F\u3060\u3057\u3001\u59FF\u3092\u63DB\u3048\u3066\u3057\u307E\u3063\u305F\u5BBF\u501F\u5996\u7CBE\u306E\u884C\u65B9\u306F\u308F\u304B\u308A\u307E\u305B\u3093\u3002 \u307E\u305F\u3001\u8759\u8760\u5996\u7CBE\u540C\u58EB\u306B\u3057\u304B\u805E\u3053\u3048\u306A\u3044\u4F1A\u8A71\u304C\u53EF\u80FD\u3067\u3059\u3002'
};
var mimicry = {
  label: '\u64EC\u72FC\u5996\u7CBE',
  win: 'PIXI',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_MIMICRY" TARGET="_blank">\u64EC\u72FC\u5996\u7CBE</A>\u3067\u3059\u3002'
};
var dyingpixi = {
  label: '\u98A8\u82B1\u5996\u7CBE',
  win: 'PIXI',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_DYINGPIXI" TARGET="_blank">\u98A8\u82B1\u5996\u7CBE</A>\u3067\u3059\u3002'
};
var trickster = {
  label: '\u60AA\u622F\u5996\u7CBE',
  win: 'PIXI',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_TRICKSTER" TARGET="_blank">\u60AA\u622F\u5996\u7CBE</A>\u3067\u3059\u3002 \u7D50\u3070\u308C\u305F\u4EBA\u305F\u3061\u306B\u3068\u3063\u3066\u306F\u3001\u5358\u306A\u308B\u306F\u305F\u8FF7\u60D1\u306A\u60AA\u622F\u306B\u3059\u304E\u307E\u305B\u3093\u3002'
};
var hatedevil = {
  label: '\u90AA\u6C17\u60AA\u9B54',
  win: 'HATER',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_HATEDEVIL" TARGET="_blank">\u90AA\u6C17\u60AA\u9B54</A>\u3067\u3059\u3002 \u7D50\u3073\u3064\u3051\u305F\u4E8C\u4EBA\u306E\u3046\u3061\u3001\u3069\u3061\u3089\u304B\u7247\u65B9\u3060\u3051\u304C\u751F\u304D\u5EF6\u3073\u308C\u3070\u3001\u3042\u306A\u305F\u306E\u52DD\u5229\u3068\u306A\u308A\u307E\u3059\u3002\u3042\u306A\u305F\u306B\u305D\u306E\u7D46\u304C\u7D50\u3070\u308C\u3066\u3044\u306A\u3044\u9650\u308A\u3001\u3042\u306A\u305F\u81EA\u8EAB\u306E\u6B7B\u306F\u52DD\u6557\u306B\u306F\u76F4\u63A5\u95A2\u4FC2\u3057\u307E\u305B\u3093\u3002'
};
var hate2 = {
  label: '\u5BBF\u6575',
  win: 'HATER',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306B\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_HATEDEVIL" TARGET="_blank">\u5BBF\u6575</A>\u304C\u3044\u307E\u3059\u3002'
};
var love3 = {
  label: '\u604B\u4EBA',
  win: 'LOVER',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306B\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_LOVEANGEL" TARGET="_blank">\u604B\u4EBA</A>\u304C\u3044\u307E\u3059\u3002'
};
var loveangel = {
  label: '\u604B\u611B\u5929\u4F7F',
  win: 'LOVER',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_LOVEANGEL" TARGET="_blank">\u604B\u611B\u5929\u4F7F</A>\u3067\u3059\u3002 \u7D50\u3073\u3064\u3051\u305F\u4E8C\u4EBA\u304C\u751F\u304D\u5EF6\u3073\u308C\u3070\u3001\u3042\u306A\u305F\u306E\u52DD\u5229\u3068\u306A\u308A\u307E\u3059\u3002\u3042\u306A\u305F\u306B\u305D\u306E\u7D46\u304C\u7D50\u3070\u308C\u3066\u3044\u306A\u3044\u9650\u308A\u3001\u3042\u306A\u305F\u81EA\u8EAB\u306E\u6B7B\u306F\u52DD\u6557\u306B\u306F\u76F4\u63A5\u95A2\u4FC2\u3057\u307E\u305B\u3093\u3002'
};
var passion = {
  label: '\u7247\u601D\u3044',
  win: 'LOVER',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_PASSION" TARGET="_blank">\u7247\u60F3\u3044</A>\u3067\u3059\u3002 \u9078\u3093\u3060\u4EBA\u304C\u751F\u304D\u5EF6\u3073\u3001\u3042\u306A\u305F\u304C\u751F\u304D\u5EF6\u3073\u308C\u3070\u3001\u3042\u306A\u305F\u306E\u52DD\u5229\u3068\u306A\u308A\u307E\u3059\u3002'
};
var lonewolf = {
  label: '\u4E00\u5339\u72FC',
  win: 'LONEWOLF',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_LONEWOLF" TARGET="_blank">\u4E00\u5339\u72FC</A>\u3067\u3059\u3002 \u8972\u6483\u5148\u306F\u3042\u306A\u305F\u4EE5\u5916\u3067\u3042\u308C\u3070\u8AB0\u3067\u3082\u304B\u307E\u3044\u307E\u305B\u3093\u3002'
};
var guru2 = {
  label: '\u7B1B\u5439\u304D',
  win: 'GURU',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_GURU" TARGET="_blank">\u7B1B\u5439\u304D</A>\u3067\u3059\u3002'
};
var dish2 = {
  label: '\u9C57\u9B5A\u4EBA',
  win: 'DISH',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_DISH" TARGET="_blank">\u9C57\u9B5A\u4EBA</A>\u3067\u3059\u3002\u65B0\u9BAE\u306A\u3075\u3043\u30FC\u3063\u3057\u3085\u3002\u3067\u3059\u3002'
};
var bitch2 = {
  label: '\u904A\u3073\u4EBA',
  win: 'LOVER',
  ...
  cmd: 'role',
  help:
    '\u3042\u306A\u305F\u306F<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_BITCH" TARGET="_blank">\u904A\u3073\u4EBA</A>\u3067\u3059\u3002 \u672C\u547D\u3068\u3042\u306A\u305F\u304C\u751F\u304D\u5EF6\u3073\u308C\u3070\u3001\u3042\u306A\u305F\u306E\u52DD\u5229\u3067\u3059\u3002'
};
...
var DISH = {
  ...
  order: 10,
  help:
    '<b><A href="http://dais.kokage.cc/guide/?(Text)WIN_DISH" TARGET="_blank">\u636E\u3048\u81B3</A></b>\n<br>\n\u3059\u3079\u3066\u306B\u6C7A\u7740\u304C\u3064\u3044\u305F\u3068\u304D\u3001\u3042\u306A\u305F\u304C\u72FC\u306E\u8972\u6483\u3001\u3082\u3057\u304F\u306F\u8CDE\u91D1\u7A3C\u306E\u9053\u9023\u308C\u306B\u3088\u308A\u6B7B\u4EA1\u3057\u3066\u3044\u308C\u3070\u3001\u52DD\u5229\u8005\u306E\u4E00\u54E1\u306B\u52A0\u308F\u308A\u307E\u3059\u3002'
};
var NONE = {
  label: '\u2015',
  group: '\u305D\u306E\u4ED6',
...
var MOB = {
  ...
  order: 99,
  help:
    '\u3042\u306A\u305F\u306F<b>_ROLE_\u306E<A href="http://dais.kokage.cc/guide/?(Role)ROLEID_MOB" TARGET="_blank">\u898B\u7269\u4EBA</A></b>\u3067\u3059\u3002\u3044\u304B\u306A\u308B\u9663\u55B6\u306E\u4EBA\u6570\u306B\u3082\u542B\u307E\u308C\u307E\u305B\u3093\u3002'
};
var LEAVE = {
  label: '\u2015',
  group: '\u305D\u306E\u4ED6',
...
var default2 = {
  ...
  role_ids_list: [
    ...
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'decide', 'wolf', 'guard', 'villager'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'decide', 'wolf', 'guard', 'possess', 'medium'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'decide', 'wolf', 'guard', 'possess', 'medium', 'villager'],
    [
      'villager',
      'villager',
      'seer',
...
var mistery = {
  ...
  role_ids_list: [
    ...
    ['villager', 'villager', 'guard', 'wolf', 'wolf', 'alchemist', 'decide', 'aura', 'doctor', 'villager'],
    ['villager', 'villager', 'guard', 'wolf', 'childwolf', 'alchemist', 'decide', 'aura', 'doctor', 'villager', 'villager'],
    ['villager', 'villager', 'guard', 'wolf', 'childwolf', 'alchemist', 'decide', 'aura', 'doctor', 'villager', 'seer', 'villager'],
    [
      'villager',
      'villager',
      'guard',
...
var test1st = {
  ...
  role_ids_list: [
    ...
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'possess'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'possess', 'guard'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'possess', 'guard', 'villager'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'possess', 'guard', 'stigma', 'possess'],
    [
      'villager',
      'villager',
      'seer',
...
var test2nd = {
  ...
  role_ids_list: [
    ...
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'fanatic'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'fanatic', 'guard'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'fanatic', 'guard', 'villager'],
    [
      'villager',
      'villager',
      'seer',
...
var wbbs_c = {
  ...
  role_ids_list: [
    ...
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'wisper'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'wisper', 'guard'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'wisper', 'guard', 'villager'],
    [
      'villager',
      'villager',
      'seer',
...
var wbbs_g = {
  ...
  role_ids_list: [
    ...
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'possess', 'guard'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'possess', 'guard', 'villager'],
    ['villager', 'villager', 'seer', 'wolf', 'villager', 'villager', 'villager', 'wolf', 'medium', 'possess', 'guard', 'villager', 'wolf'],
    [
      'villager',
      'villager',
      'seer',
...
var cards = model2({
  ...
  initialize(doc) {
    ...
    for (const able of doc.ables) {
      ...
      if (able.text) {
        if ((_a2 = doc.story.say_limit) == null ? void 0 : _a2.count) act.unit = 'count';
        if ((_b2 = doc.story.say_limit) == null ? void 0 : _b2.all) act.unit = 'all';
      }
    }
  },
  reduce(data, doc) {},
...
var story_summary2 = model(
  __spreadProps(__spreadValues({}, stories2), {
    $match: (is_old) => ({
      is_epilogue: is_old,
      is_finish: is_old
    }),
...
var OPTIONS = [process.env.pm_id, process.env.NODE_ENV, process.env.autorestart, process.env.exec_mode];
console.log(OPTIONS);
