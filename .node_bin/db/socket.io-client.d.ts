...
declare type StoreEntry<F extends BaseF<BaseT<any>>, OrderArgs extends any[], MatchArgs extends any[]> = QueryProps<MatchArgs> & MapReduceProps<F, OrderArgs>;
export declare type BaseStoreEntry = StoreEntry<BaseF<BaseT<any>>, any[], any[]>;
declare let STORE: {
    [name: string]: BaseStoreEntry;
};
export declare function model<F extends BaseF<BaseT<any>>, OrderArgs extends any[], MatchArgs extends any[]>(props: StoreEntry<F, OrderArgs, MatchArgs>): {
    name?: string;
    qid: (...args: MatchArgs) => string;
...
export declare function model<F extends BaseF<BaseT<any>>, OrderArgs extends any[]>(props: MapReduceProps<F, OrderArgs>): {
    index?: (_id: F['list'][number]['_id']) => string | number | boolean | null;
    format: () => F;
    reduce: (o: F, doc: F['list'][number]) => void;
    order: (o: F, { sort, group_sort }: typeof OrderUtils, ...args: OrderArgs) => void;
...
export declare function socket<F extends BaseF<any>, MatchArgs extends any[], OrderArgs extends any[]>({ name, qid, index, format, order, reduce }: StoreEntry<F, OrderArgs, MatchArgs>): {
