...
declare type ModelEntry<T, MatchArgs extends any[], MatchReturn> =
...
export declare function model<T, MatchArgs extends any[], MatchReturn>(
  o: ModelEntry<T, MatchArgs, MatchReturn>
): ModelEntry<T, MatchArgs, MatchReturn>;
